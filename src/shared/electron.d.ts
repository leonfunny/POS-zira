...
interface ElectronAPI {
  ...
  pos: {
    ...
    masterCatalog: {
      ...
      scanCreate: (payload: { ean: string; name?: string; attachVariantId?: string; purchasePrice?: number; retailPrice?: number; stockQty?: number; taxRate?: number; warehouseId?: string; categoryId?: string | null; createIfMiss?: boolean; idempotencyKey?: string }) => Promise<{
        ok: boolean;
        outcome?: string;
        mode?: string;
        productId?: string;
        ...
        importDraft: (payload: { ean: string; retailPriceGrosze?: number; categoryId?: string; stockQty?: number }) => Promise<{
        ok: boolean;
        outcome?: string;
        variant?: any;
        syncPending?: boolean;
