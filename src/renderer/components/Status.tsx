    ...
    <div className="space-y-4">
      ...
      <div className="panel p-4">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            >
              <svg className={`w-5 h-5 ${deviceStatus?.printerConnected ? 'text-green-600' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="panel p-4">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <svg className={`w-5 h-5 ${deviceStatus?.scannerActive ? 'text-green-600' : 'text-slate-400'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
