    ...
    return (
      <div className="flex-1 flex items-center justify-center text-slate-500 bg-white border border-slate-200 rounded-lg">
        <div className="text-center px-6 py-8 max-w-md">
          ...
          <p className="text-base font-bold text-slate-700 mb-1">{t?.('pos.noProducts') ?? 'Chưa có sản phẩm nào'}</p>
          <p className="text-xs text-slate-400">
            Salon chưa có sản phẩm trên eNail Cloud hoặc đang chờ đồng bộ. Bạn có thể thêm sản phẩm trên Web Admin hoặc quét mã barcode để tạo nhanh.
          </p>
        </div>
      </div>
    );
