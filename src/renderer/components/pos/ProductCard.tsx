    ...
    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col p-2 h-full">
      ...
      <div className="flex items-center justify-between px-0.5 shrink-0">
        ...
        <button
          ...
          className="w-11 h-11 bg-brand-500 hover:bg-brand-600 active:bg-brand-700 text-white rounded-full flex items-center justify-center shadow-sm active:scale-95 transition-all cursor-pointer touch-manipulation shrink-0"
        >
