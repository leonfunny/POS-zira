...
import { eastSlavicForm } from './plural';
...
const COPY: Record<string, LabelCopy> = {
  ...
  tr: {
    title: 'Etiket',
    subtitle: 'Poşet etiketlerini ve kumaş etiketlerini yeniden yazdırın',
    settings: 'Ayarlar',
    close: 'Kapat',
    sync: 'Eşitle',
    manageCategories: 'Kategoriler',
    manageCategoriesUnavailable: 'Kategoriler şu anda bu kasadan yönetilemiyor',
    syncing: 'Eşitleniyor',
    search: 'Ad, SKU, EAN, kategori ara',
    allCategories: 'Tüm etiket ürünleri',
    products: 'ürün',
    selected: 'Seçili',
    setupTitle: 'Kategori veya sabitlenmiş ürün seçin',
    setupHint: 'Bu kasa ayarlanana kadar Etiket sekmesi boş kalır.',
    openSettings: 'Ayarları aç',
    noMatch: 'Eşleşen etiket ürünü yok',
    noSelection: 'Model seçilmedi',
    backToList: 'Listeye dön',
    sheetLoading: 'Sayfa açılıyor…',
    loading: 'Ürünler yükleniyor...',
    loadError: 'Ürünler yüklenemedi',
    selectProductHint: 'Bir model seçin: sayfası tüm renk ve bedenlerle açılır, yazdırmaya veya değiştirmeye hazır.',
    category: 'Kategori',
    missingEan: 'EAN eksik',
    categories: 'Kategoriler',
    categoryHint: 'Seçilen kategoriler Etiket sekmesinde görünür.',
    pinnedProducts: 'Sabitlenmiş ürünler',
    pinSearch: 'Sabitlemek için ürün ara',
    pinned: 'Sabitlendi',
    availableProducts: 'Mevcut ürünler',
    clear: 'Temizle',
    noCategories: 'Yerel kategori bulunamadı',
    noProductsAvailable: 'Ürün bulunamadı',
    staleSelections: (quantity) => `Kayıtlı ${quantity} Etiket seçimi artık mevcut değil veya yazdırılamıyor.`,
    repair: 'Ayarları onar',
    variantSummary: (colors, sizes, rows) =>
      colors + sizes === 0 ? `${rows} satır` : `${colors} renk · ${sizes} beden`,
    chooseLabelType: 'Etiket türünü seçin',
    tabPrintOrder: 'Baskı siparişi',
    tabFabricFromFile: 'Müşteri dosyalarından kumaş etiketleri',
    tabProductCode: 'Ürün kodu / EAN etiketi',
  },
  zh: {
    title: '标签',
    subtitle: '重新打印包装标签和布标',
    settings: '设置',
    close: '关闭',
    sync: '同步',
    manageCategories: '类别',
    manageCategoriesUnavailable: '目前无法从这台收银机管理类别',
    syncing: '同步中',
    search: '搜索名称、SKU、EAN、类别',
    allCategories: '全部标签商品',
    products: '件商品',
    selected: '已选',
    setupTitle: '选择类别或置顶商品',
    setupHint: '在这台收银机完成设置前，标签页保持为空。',
    openSettings: '打开设置',
    noMatch: '没有匹配的标签商品',
    noSelection: '未选择款式',
    backToList: '返回列表',
    ...
    loading: '正在加载商品...',
    loadError: '无法加载商品',
    selectProductHint: '选择一个款式：单页会带出全部颜色和尺码，可直接打印或修改。',
    category: '类别',
    missingEan: '缺少 EAN',
    categories: '类别',
    categoryHint: '所选类别会显示在标签页中。',
    pinnedProducts: '置顶商品',
    pinSearch: '搜索要置顶的商品',
    pinned: '已置顶',
    availableProducts: '可选商品',
    clear: '清除',
    noCategories: '未找到本地类别',
    noProductsAvailable: '未找到商品',
    staleSelections: (quantity) => `已保存的 ${quantity} 个标签选择不再存在或无法打印。`,
    repair: '修复设置',
    variantSummary: (colors, sizes, rows) =>
      colors + sizes === 0 ? `${rows} 行` : `${colors} 种颜色 · ${sizes} 个尺码`,
    chooseLabelType: '选择标签类型',
    tabPrintOrder: '打印单',
    tabFabricFromFile: '来自客户文件的布标',
    tabProductCode: '商品编码 / EAN 标签',
  },
  uk: {
    title: 'Етикетка',
    subtitle: 'Передрук пакувальних етикеток і текстильних бирок',
    settings: 'Налаштування',
    close: 'Закрити',
    sync: 'Синхронізувати',
    manageCategories: 'Категорії',
    manageCategoriesUnavailable: 'Зараз категоріями не можна керувати з цієї каси',
    syncing: 'Синхронізація',
    search: 'Пошук за назвою, SKU, EAN, категорією',
    allCategories: 'Усі товари з етикетками',
    products: 'товарів',
    selected: 'Вибрано',
    setupTitle: 'Оберіть категорії або закріплені товари',
    setupHint: 'Вкладка «Етикетка» лишається порожньою, доки цю касу не налаштовано.',
    openSettings: 'Відкрити налаштування',
    noMatch: 'Немає товарів, що відповідають запиту',
    noSelection: 'Модель не обрано',
    backToList: 'Назад до списку',
    sheetLoading: 'Відкриваємо аркуш…',
    loading: 'Завантаження товарів...',
    loadError: 'Не вдалося завантажити товари',
    selectProductHint: 'Оберіть модель: її аркуш відкриється з усіма кольорами й розмірами, готовий до друку чи змін.',
    category: 'Категорія',
    missingEan: 'Немає EAN',
    categories: 'Категорії',
    categoryHint: 'Обрані категорії видно на вкладці «Етикетка».',
    pinnedProducts: 'Закріплені товари',
    pinSearch: 'Знайти товар для закріплення',
    pinned: 'Закріплено',
    availableProducts: 'Доступні товари',
    clear: 'Очистити',
    noCategories: 'Локальних категорій не знайдено',
    noProductsAvailable: 'Товарів не знайдено',
    staleSelections: (quantity) =>
      `${quantity} ${eastSlavicForm(quantity, 'збережений вибір', 'збережені вибори', 'збережених виборів')} на вкладці «Етикетка» більше не існує або їх не можна надрукувати.`,
    repair: 'Полагодити налаштування',
    variantSummary: (colors, sizes, rows) =>
      colors + sizes === 0
        ? `${rows} ${eastSlavicForm(rows, 'рядок', 'рядки', 'рядків')}`
        : `${colors} ${eastSlavicForm(colors, 'колір', 'кольори', 'кольорів')} · ${sizes} ${eastSlavicForm(sizes, 'розмір', 'розміри', 'розмірів')}`,
    chooseLabelType: 'Оберіть тип етикетки',
    tabPrintOrder: 'Замовлення на друк',
    tabFabricFromFile: 'Текстильні бирки з файлів клієнта',
    tabProductCode: 'Код товару / етикетка EAN',
  },
  ru: {
    title: 'Этикетка',
    subtitle: 'Повторная печать упаковочных этикеток и текстильных бирок',
    settings: 'Настройки',
    close: 'Закрыть',
    sync: 'Синхронизировать',
    manageCategories: 'Категории',
    manageCategoriesUnavailable: 'Сейчас категориями нельзя управлять с этой кассы',
    syncing: 'Синхронизация',
    search: 'Поиск по названию, SKU, EAN, категории',
    allCategories: 'Все товары с этикетками',
    products: 'товаров',
    selected: 'Выбрано',
    setupTitle: 'Выберите категории или закреплённые товары',
    setupHint: 'Вкладка «Этикетка» остаётся пустой, пока эта касса не настроена.',
    openSettings: 'Открыть настройки',
    noMatch: 'Подходящих товаров нет',
    noSelection: 'Модель не выбрана',
    backToList: 'Назад к списку',
    sheetLoading: 'Открываем лист…',
    loading: 'Загрузка товаров...',
    loadError: 'Не удалось загрузить товары',
    selectProductHint: 'Выберите модель: её лист откроется со всеми цветами и размерами, готовый к печати или правке.',
    category: 'Категория',
    missingEan: 'Нет EAN',
    categories: 'Категории',
    categoryHint: 'Выбранные категории видны на вкладке «Этикетка».',
    pinnedProducts: 'Закреплённые товары',
    pinSearch: 'Найти товар для закрепления',
    pinned: 'Закреплено',
    availableProducts: 'Доступные товары',
    clear: 'Очистить',
    noCategories: 'Локальные категории не найдены',
    noProductsAvailable: 'Товары не найдены',
    staleSelections: (quantity) =>
      `${quantity} ${eastSlavicForm(quantity, 'сохранённый выбор', 'сохранённых выбора', 'сохранённых выборов')} на вкладке «Этикетка» больше не существует или их нельзя напечатать.`,
    repair: 'Починить настройки',
    variantSummary: (colors, sizes, rows) =>
      colors + sizes === 0
        ? `${rows} ${eastSlavicForm(rows, 'строка', 'строки', 'строк')}`
        : `${colors} ${eastSlavicForm(colors, 'цвет', 'цвета', 'цветов')} · ${sizes} ${eastSlavicForm(sizes, 'размер', 'размера', 'размеров')}`,
    chooseLabelType: 'Выберите тип этикетки',
    tabPrintOrder: 'Заказ на печать',
    tabFabricFromFile: 'Текстильные бирки из файлов клиента',
    tabProductCode: 'Код товара / этикетка EAN',
  },
  vi: {
    title: 'Label',
