    ...
    <div className="h-full flex flex-col relative overflow-hidden" onPointerDown={handleContainerTap}>
      ...
      <div className="shrink-0 pt-3 border-t border-stone-100">
        <button
          ...
          className="w-full py-3.5 bg-brand-600 text-white text-sm font-bold rounded-xl hover:bg-brand-700 transition-colors cursor-pointer shadow-sm flex items-center justify-center gap-2"
        >
...
function ServiceCard({ svc }: { svc: ServiceItem }) {
  return (
    <div className="flex items-center gap-3 px-4 py-3.5 bg-white rounded-2xl border border-stone-200">
