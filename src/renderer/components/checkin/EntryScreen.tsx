      ...
      <div className="flex flex-col items-center gap-6 mt-6">
        ...
        <div className="w-full grid grid-cols-5 gap-6">
          ...
          >
            ...
            <div className="mt-5 flex items-center gap-2 text-brand-500 font-semibold group-hover:translate-x-1.5 transition-transform duration-200">
              <span className="text-sm uppercase tracking-widest">{t('wizard.findMyBooking')}</span>
          ...
          <button
            onClick={onWalkIn}
            className="col-span-3 group relative flex flex-col items-center justify-center p-8 bg-brand-700 rounded-3xl border border-brand-700 hover:bg-brand-800 hover:shadow-xl active:scale-[0.97] transition-all duration-300 text-center overflow-hidden"
          >
        ...
        {bookingCount > 0 && (
          <div className="flex items-center gap-2 px-5 py-2.5 bg-brand-50 rounded-full border border-brand-100">
            ...
            <span className="text-sm font-bold uppercase tracking-widest text-brand-700">
