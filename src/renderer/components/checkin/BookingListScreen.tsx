...
function isLate(booking: BooksyBookingSummary): boolean {
...
interface Props {
  t: (key: string) => string;
  bookings: BooksyBookingSummary[];
  checkins: any[];
  onSelect: (booking: BooksyBookingSummary) => void;
  onBack: () => void;
}

export default function BookingListScreen({ t, bookings, checkins, onSelect, onBack }: Props) {
